...
struct ImGuiPlatformIO
{
    ...
    void    (*Platform_ShowWindow)(ImGuiViewport* vp);                      // . . U . .  // Newly created windows are initially hidden so SetWindowPos/Size/DebugCategory can be called on them before showing the window
